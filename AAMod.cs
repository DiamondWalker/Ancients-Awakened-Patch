    ...
    public class AAMod : Mod
    {
        ...
        public void LoadClient()
        {
            ...
            if (GetSoundSlot(SoundType.Music, "Sounds/Music/Monarch") != 0) //ensure music was loaded!
            {
                ...
                if (GetSoundSlot(SoundType.Music, "Sounds/Music/SupremeRajah") != 0) AddMusicBox(GetSoundSlot(SoundType.Music, "Sounds/Music/SupremeRajah"), ItemType("SRajahBox"), TileType("SRajahBox"));
            }
        ...
        private void BossTitle(int BossID) {
            ...
            switch (BossID) {
                ...
                case 18:
                    ...
                    break;
                case 19:
                    BossName = Lang.BossTitle("MLName");
                    BossTitle = Lang.BossTitle("MLTitle");
            ...
            switch (BossID) {
                case 16: {
                        Vector2 textSize5 = Main.fontDeathText.MeasureString(BossTitle) * 0.6f;
                        float text2PositionLeft3 = (float)(Main.screenWidth / 2) - textSize5.X / 2f;
                        DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontDeathText, BossTitle, new Vector2(text2PositionLeft3, Main.screenHeight / 2 - 350), titleColor * ((255f - alpha2) / 255f), 0f, Vector2.Zero, 0.6f, SpriteEffects.None, 0f);
                        ...
                        float APositionLeft = (float)(Main.screenWidth / 2) - (ASize.X + BlankTexSize.X + AndSize.X + BlankTexSize.X + HSize.X) / 2f;
                        float AndPositionLeft = APositionLeft + ASize.X + BlankTexSize.X;
                        float HPositionLeft = AndPositionLeft + AndSize.X + BlankTexSize.X;
                        DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontDeathText, Lang.BossTitle("AsheName"), new Vector2(APositionLeft, Main.screenHeight / 2 - 300), Color.OrangeRed * ((255f - alpha) / 255f), 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
                        DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontDeathText, Lang.BossTitle("AHANd"), new Vector2(AndPositionLeft, Main.screenHeight / 2 - 300), Color.Magenta * ((255f - alpha3) / 255f), 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
                        DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontDeathText, Lang.BossTitle("HarukaName"), new Vector2(HPositionLeft, Main.screenHeight / 2 - 300), Color.Indigo * ((255f - alpha4) / 255f), 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
                        break;
                    }
                case 14: {
                        string[] BossNameSplit = BossName.Split(' ');
                        string[] BossTitleSplit = BossTitle.Split(' ');
                        ...
                        Vector2 textSize2 = Main.fontDeathText.MeasureString("~ " + BossName + " ~");
                        Vector2 textSize4 = Main.fontDeathText.MeasureString(BossTitle) * 0.6f;
                        float textPositionLeft2 = (float)(Main.screenWidth / 2) - textSize2.X / 2f;
                        float text2PositionLeft2 = (float)(Main.screenWidth / 2) - textSize4.X / 2f;
                        int k = 0;
                        string[] array = BossTitleSplit;
                        foreach (string i in array) {
                            if (!(i == "") && !(i == " ")) {
                                Vector2 SplitSizeTitle = Main.fontDeathText.MeasureString(i) * 0.6f;
                                Vector2 BlankTexSizeTitle = Main.fontDeathText.MeasureString(" ") * 0.6f;
                                DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontDeathText, ((Language.ActiveCulture == GameCulture.Chinese) ? "" : " ") + i, new Vector2(text2PositionLeft2, Main.screenHeight / 2 - 350), ((k % 2 == 0) ? Color.OrangeRed : Color.Indigo) * ((255f - alpha2) / 255f), 0f, Vector2.Zero, 0.6f, SpriteEffects.None, 0f);
                                text2PositionLeft2 += SplitSizeTitle.X + ((Language.ActiveCulture == GameCulture.Chinese) ? 0f : BlankTexSizeTitle.X);
                                k++;
                            }
                        }
                        Vector2 SplitSize = Main.fontDeathText.MeasureString("~");
                        DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontDeathText, "~" + ((Language.ActiveCulture == GameCulture.Chinese) ? " " : ""), new Vector2(textPositionLeft2, Main.screenHeight / 2 - 300), Color.OrangeRed * ((255f - alpha2) / 255f), 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
                        textPositionLeft2 += SplitSize.X;
                        k = 0;
                        array = BossNameSplit;
                        foreach (string j in array) {
                            if (!(j == "") && !(j == " ")) {
                                Vector2 SplitSizeName = Main.fontDeathText.MeasureString(j);
                                Vector2 BlankTexSizeName = Main.fontDeathText.MeasureString(" ");
                                DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontDeathText, ((Language.ActiveCulture == GameCulture.Chinese) ? "" : " ") + j, new Vector2(textPositionLeft2, Main.screenHeight / 2 - 300), ((k % 2 == 0) ? Color.OrangeRed : Color.Indigo) * ((255f - alpha2) / 255f), 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
                                textPositionLeft2 += SplitSizeName.X + ((Language.ActiveCulture == GameCulture.Chinese) ? 0f : BlankTexSizeName.X);
                                k++;
                            }
                        }
                        DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontDeathText, " ~", new Vector2(textPositionLeft2, Main.screenHeight / 2 - 300), Color.Indigo * ((255f - alpha2) / 255f), 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
                        break;
                    }
                default: {
                        Vector2 textSize = Main.fontDeathText.MeasureString("~ " + BossName + " ~");
                        Vector2 textSize3 = Main.fontDeathText.MeasureString(BossTitle) * 0.6f;
                        float textPositionLeft = (float)(Main.screenWidth / 2) - textSize.X / 2f;
                        float text2PositionLeft = (float)(Main.screenWidth / 2) - textSize3.X / 2f;
                        DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontDeathText, BossTitle, new Vector2(text2PositionLeft, Main.screenHeight / 2 - 350), titleColor * ((255f - alpha2) / 255f), 0f, Vector2.Zero, 0.6f, SpriteEffects.None, 0f);
                        DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontDeathText, "~ " + BossName + " ~", new Vector2(textPositionLeft, Main.screenHeight / 2 - 300), titleColor * ((255f - alpha) / 255f), 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
                        break;
                    }
            }
        }
        ...
        public static void ShowTitle(NPC npc, int ID) {
            if (AAConfigClient.Instance.AncientIntroText) {
                Projectile.NewProjectile(npc.Center, Vector2.Zero, ModContent.ProjectileType<Title>(), 0, 0f, Main.myPlayer, ID);
            }
        }

        public static void ShowTitle(Player player, int ID) {
            if (AAConfigClient.Instance.AncientIntroText) {
                Projectile.NewProjectile(player.Center, Vector2.Zero, ModContent.ProjectileType<Title>(), 0, 0f, Main.myPlayer, ID);
            }
        }

        public static void ShowSistersTitle(NPC npc) {
            if (AAConfigClient.Instance.AncientIntroText) {
                Projectile.NewProjectile(npc.Center, Vector2.Zero, ModContent.ProjectileType<SistersTitle>(), 0, 0f, Main.myPlayer, 16f);
            }
        }
        ...
        public override void UpdateMusic(ref int music, ref MusicPriority priority)
        {
            ...
            if (zoneShen && AAWorld.shenUnlocked)
            {
