...
namespace AAMod.Water {
    public class MireWaterStyle : ModWaterStyle
	{
		public override bool ChooseWaterStyle()
        {
            ...
            if (Main.bgStyle == mod.GetSurfaceBgStyleSlot("MireSurfaceBgStyle") || Main.bgStyle == mod.GetSurfaceBgStyleSlot("MireDesertBgStyle") || (player.ZoneSnow && player.GetModPlayer<AABiomesPlayer>().ZoneMire))
            {
