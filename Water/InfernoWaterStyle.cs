...
namespace AAMod.Water {
    public class InfernoWaterStyle : ModWaterStyle
	{
		public override bool ChooseWaterStyle()
        {
            ...
            if (Main.bgStyle == mod.GetSurfaceBgStyleSlot("InfernoSurfaceBgStyle") || Main.bgStyle == mod.GetSurfaceBgStyleSlot("InfernoDesertBgStyle") || (player.ZoneSnow && player.GetModPlayer<AABiomesPlayer>().ZoneInferno))
            {
                return true;
            }
            return false;
