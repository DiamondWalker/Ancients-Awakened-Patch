    ...
    internal class WeakReferences
    {
        ...
        private static void PerformHealthBarSupport()
        {
            ...
            if (yabhb != null)
            {
                ...
                yabhb.Call("hbStart");
                yabhb.Call("hbSetTexture",
                    AAMod.instance.GetTexture("Healthbars/AsheBarHead"),
                    AAMod.instance.GetTexture("Healthbars/AsheBarBody"),
                    AAMod.instance.GetTexture("Healthbars/AsheBarTail"),
                    null);
                yabhb.Call("hbSetColours",
                    Color.OrangeRed,
                    Color.OrangeRed,
                    Color.OrangeRed);
                yabhb.Call("hbFinishSingle", AAMod.instance.NPCType("Ashe"));
                ...
                yabhb.Call("hbStart");
                yabhb.Call("hbSetTexture",
                    AAMod.instance.GetTexture("Healthbars/BGBarHead"),
                    AAMod.instance.GetTexture("Healthbars/BGBarBody"),
                    AAMod.instance.GetTexture("Healthbars/BGBarTail"),
                    null);
                yabhb.Call("hbSetColours",
                    new Color(150, 30, 5),
                    new Color(150, 30, 5),
                    new Color(150, 30, 5));
                yabhb.Call("hbFinishSingle", AAMod.instance.NPCType("BlazeGrip"));

                // Discordian Grip (Blue)
                yabhb.Call("hbStart");
                yabhb.Call("hbSetTexture",
                    AAMod.instance.GetTexture("Healthbars/AGBarHead"),
                    AAMod.instance.GetTexture("Healthbars/AGBarBody"),
                    AAMod.instance.GetTexture("Healthbars/AGBarTail"),
                    null);
                yabhb.Call("hbSetColours",
                    new Color(4, 31, 94),
                    new Color(4, 31, 94),
                    new Color(4, 31, 94));
                yabhb.Call("hbFinishSingle", AAMod.instance.NPCType("AbyssGrip"));
            }
        }
