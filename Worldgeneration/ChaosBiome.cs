...
namespace AAMod.Worldgeneration
{
    ...
    public class CrystalClear : MicroBiome {
        public override bool Place(Point origin, StructureMap structures) {
            Mod mod = AAMod.instance;
            ...
            TexGen gen = BaseWorldGenTex.GetTexGenerator(mod.GetTexture("Worldgeneration/EnderCrystalClear"), colorToTile);
            gen.Generate(origin.X, origin.Y, true, true);
    ...
    public class Crystal : MicroBiome
    {
        public override bool Place(Point origin, StructureMap structures)
        {
            ...
            WorldGen.PlaceObject(origin.X + 27 + 2, origin.Y + 26 + 10, (ushort)mod.TileType("EnderMemory"));
            NetMessage.SendObjectPlacment(-1, origin.X + 27 + 2, origin.Y + 26 + 10, (ushort)mod.TileType("EnderMemory"), 0, 0, -1, -1);
