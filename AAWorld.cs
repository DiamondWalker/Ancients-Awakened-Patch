...
namespace AAMod
{
    public class AAWorld : ModWorld
    {
        ...
        private static EnumAncients firstAncient;
        private static EnumSuperancients firstSuperancient;
        //Points
        ...
        public override void Initialize()
        {
            ...
            firstAncient = EnumAncients.None;
            firstSuperancient = EnumSuperancients.None;
            //World Changes
        ...
        public override TagCompound Save()
        {
            ...
            return new TagCompound {
                ...
                {"Egg", SmashDragonEgg},
                {"Pod", SmashHydraPod},
                {"FirstAncient", (int)firstAncient },
                {"FirstSuperancient", (int)firstSuperancient }
            };
        }
        ...
        public override void Load(TagCompound tag)
        {
            ...
            firstAncient = (EnumAncients)tag.GetInt("FirstAncient");
            firstSuperancient = (EnumSuperancients)tag.GetInt("FirstSuperancient");
        }
        ...
        public override void NetSend(BinaryWriter writer)
        {
            ...
            writer.Write((int)firstAncient);
            writer.Write((int)firstSuperancient);
        }
        ...
        public override void NetReceive(BinaryReader reader)
        {
            ...
            firstAncient = (EnumAncients)reader.ReadInt32();
            firstSuperancient = (EnumSuperancients)reader.ReadInt32();
        }
        ...
        private void EnderShrine()
        {
            ...
            CrystalClear delete = new CrystalClear();
            delete.Place(origin, WorldGen.structures);
            biome.Place(origin, WorldGen.structures);
        }
