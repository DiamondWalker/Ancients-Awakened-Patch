    ...
    public class YamataA : YamataBoss
    {
        ...
        public override void NPCLoot()
        {
            if (Main.expertMode)
            {
                ...
                AAWorld.downAncient(EnumAncients.Yamata);
        ...
        public void resetHeads() {
            ((YamataAHead)TrueHead.modNPC).internalAI[0] = 0;
            ((YamataAHead)TrueHead.modNPC).internalAI[1] = 0;
            ((YamataAHead)TrueHead.modNPC).internalAI[2] = 0;
            ((YamataAHead)TrueHead.modNPC).internalAI[3] = 0;

            ((YamataAHeadF)Head2.modNPC).internalAI[0] = 0;
            ((YamataAHeadF)Head2.modNPC).internalAI[1] = 0;
            ((YamataAHeadF)Head2.modNPC).internalAI[2] = 0;
            ((YamataAHeadF)Head2.modNPC).internalAI[3] = 0;

            ((YamataAHeadF)Head3.modNPC).internalAI[0] = 0;
            ((YamataAHeadF)Head3.modNPC).internalAI[1] = 0;
            ((YamataAHeadF)Head3.modNPC).internalAI[2] = 0;
            ((YamataAHeadF)Head3.modNPC).internalAI[3] = 0;

            ((YamataAHeadF)Head4.modNPC).internalAI[0] = 0;
            ((YamataAHeadF)Head4.modNPC).internalAI[1] = 0;
            ((YamataAHeadF)Head4.modNPC).internalAI[2] = 0;
            ((YamataAHeadF)Head4.modNPC).internalAI[3] = 0;

            ((YamataAHeadF)Head5.modNPC).internalAI[0] = 0;
            ((YamataAHeadF)Head5.modNPC).internalAI[1] = 0;
            ((YamataAHeadF)Head5.modNPC).internalAI[2] = 0;
            ((YamataAHeadF)Head5.modNPC).internalAI[3] = 0;

            ((YamataAHeadF)Head6.modNPC).internalAI[0] = 0;
            ((YamataAHeadF)Head6.modNPC).internalAI[1] = 0;
            ((YamataAHeadF)Head6.modNPC).internalAI[2] = 0;
            ((YamataAHeadF)Head6.modNPC).internalAI[3] = 0;

            ((YamataAHeadF)Head7.modNPC).internalAI[0] = 0;
            ((YamataAHeadF)Head7.modNPC).internalAI[1] = 0;
            ((YamataAHeadF)Head7.modNPC).internalAI[2] = 0;
            ((YamataAHeadF)Head7.modNPC).internalAI[3] = 0;
        ...
        public void nextAttack(bool laugh = false) {
            if (laugh) {
                YamataAHead head = (YamataAHead)TrueHead.modNPC;
                if (head.laughTimer <= 0) {
                    head.laughTimer = 120;
                } // head will already be reset
            }
            internalAI[0]++;
            internalAI[1] = 0;
            npc.netUpdate = true;
        ...
        public override void AI()
        {
            ...
            if (!TrueHead.active || !Head2.active || !Head3.active || !Head4.active || !Head5.active || !Head6.active || !Head7.active) {
