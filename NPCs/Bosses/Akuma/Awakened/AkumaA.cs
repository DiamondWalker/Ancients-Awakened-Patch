...
namespace AAMod.NPCs.Bosses.Akuma.Awakened
{
    ...
    public class AkumaA : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            npc.alpha = 255;
            AAWorld.handleAncientBuff(npc, EnumAncients.Akuma);
            musicPriority = MusicPriority.BossHigh;
        }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            Texture2D glowTex = mod.GetTexture("Glowmasks/AkumaABody_Glow");
            if (npc.type == ModContent.NPCType<AkumaA>())
            {
                if (npc.ai[0] == 0 || npc.ai[0] == 1 || npc.ai[0] == 5 || npc.ai[0] == 9)
                {
                    ...
                    glowTex = mod.GetTexture("Glowmasks/AkumaA1_Glow");
                }
                else
                {
            ...
            BaseDrawing.DrawTexture(spriteBatch, glowTex, shader, npc.position, npc.width, npc.height, npc.scale, npc.rotation, npc.spriteDirection, 3, npc.frame, npc.GetAlpha(Color.White), true);
            return false;
        }
