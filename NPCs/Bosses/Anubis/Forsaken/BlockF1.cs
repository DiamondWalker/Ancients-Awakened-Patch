...
namespace AAMod.NPCs.Bosses.Anubis.Forsaken
{
    public class BlockF1 : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("Cursed Sandstone Slab");
        ...
        public override bool PreDraw(SpriteBatch sb, Color dColor)
        {
            ...
            BaseDrawing.DrawTexture(sb, Main.projectileTexture[projectile.type], 0, projectile.position, projectile.width, projectile.height, projectile.scale, projectile.rotation, 0, 6, frame, dColor, false);
            return false;
        }
    }
}