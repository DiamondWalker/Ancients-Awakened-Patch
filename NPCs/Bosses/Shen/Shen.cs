...
namespace AAMod.NPCs.Bosses.Shen {
    ...
    public class Shen : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            AAWorld.handleSuperancientBuff(npc, EnumSuperancients.Shen);
        ...
        public void Roar(int timer, bool fireSound)
        {
            ...
            if (fireSound)
            {
                Main.PlaySound(mod.GetLegacySoundSlot(SoundType.Custom, "Sounds/Sounds/Lazer"), npc.Center);//Main.PlaySound(4, (int)npc.Center.X, (int)npc.Center.Y, 60);
            }
            else
            {
        ...
        public override bool PreAI() {
            if (!this.title) {
                AAMod.ShowTitle(base.npc, this.isAwakened ? 15 : 14);
                this.title = true;
            }
            return true;
        }
        ...
        public override void NPCLoot()
        {
            if (npc.type != ModContent.NPCType<ShenA>())
            {
                ...
                if (!Main.expertMode)
                {
                    ...
                    AAWorld.downSuperancient(EnumSuperancients.Shen);
