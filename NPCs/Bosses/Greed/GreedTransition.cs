...
namespace AAMod.NPCs.Bosses.Greed
{
    public class GreedTransition : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor) {
            BaseDrawing.DrawTexture(spriteBatch, mod.GetTexture("NPCs/Bosses/Greed/GreedSpawn"), 0, npc.position + new Vector2(0, npc.gfxOffY), npc.width, npc.height, npc.scale, 0, npc.spriteDirection, Main.npcFrameCount[npc.type], npc.frame, npc.GetAlpha(AAColor.COLOR_WHITEFADE1), true);
