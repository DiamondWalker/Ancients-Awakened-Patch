...
namespace AAMod.NPCs.Enemies.Inferno {
    public class Lung : ModNPC
	{
        ...
        {
            Lighting.AddLight(npc.Center, Color.DeepSkyBlue.R / 255, Color.DeepSkyBlue.G / 255, Color.DeepSkyBlue.B / 255);
        ...
        {
            BaseAI.DropItem(npc, mod.ItemType("SearingSpark"), 1 + Main.rand.Next(2), 3, 100, true);
        }
