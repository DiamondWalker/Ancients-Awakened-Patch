            ...
            if(Language.ActiveCulture == GameCulture.Chinese)
            ...
            else
                {
                    switch(BossInfo)
                    {
                        ...
                        case "AnubisWarn":
                        return "Hey, kid, you might wanna head back to the desert...";

                        case "AnubisForfeit":
                        return "Forfeiting the match?";
                    ...
                    case "Anubis1":
                        ...
                        case "FAnubisWarn":
                        return "Go back to the desert. You might not be able to run away in a real fight.";
